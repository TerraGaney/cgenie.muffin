...
SUBROUTINE initialise_gem()
  ...
  if (par_adj_carbconst_option == 'MarChemSpec') then
    call sub_load_gem_MCS_lookup_K1
    call sub_load_gem_MCS_lookup_K2
    call sub_load_gem_MCS_lookup_Kcal
    call sub_load_gem_MCS_lookup_Karg
    call sub_load_gem_MCS_lookup_Kw
    call sub_load_gem_MCS_lookup_K0
    call sub_load_gem_MCS_lookup_Kb
    call sub_load_gem_MCS_lookup_KSO4
  endif
